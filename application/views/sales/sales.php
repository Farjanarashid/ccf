                    ...
                    <table class="display table table-bordered table-striped" id="cloudAccounting">
                        ...
                        <?php if (isset($salesmasterinfo)&& isset($accountledgerinfo)) {
                            foreach ($salesmasterinfo as $sales) {
                                ...
                                <td><a class='edit_purchase' href='<?php echo site_url('sales/sales/add_view_edit');?>?id=<?php echo $sales->salesMasterId;?>'><?php echo $sales->salesInvoiceNo;?></a> </td>
                                <td><a class='edit_purchase' href='<?php echo site_url('sales/sales/add_view_edit');?>?id=<?php echo $sales->salesMasterId;?>'> <?php
                                ...
                                <td><a class='edit_purchase' href='<?php echo site_url('sales/sales/add_view_edit');?>?id=<?php echo $sales->salesMasterId;?>'><?php echo $sales->amount;?></a> </td>
                                <td><a class='edit_purchase' href='<?php echo site_url('sales/sales/add_view_edit');?>?id=<?php echo $sales->salesMasterId;?>'><?php echo $sales->date;?></a> </td>
