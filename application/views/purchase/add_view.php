...
<form action="<?php echo site_url('purchase/purchase/add'); ?>" method="post" class="form-horizontal custom-form" role="form">
<!--main content start-->
            ...
            <div class="panel-body">
                <div class="adv-table">
                    <div class="clearfix">
                        ...
                        <div class="row purchase-top">
                            ...
                            <div class="form-group col-md-2">
                                <label for="due_days" class="col-md-5 control-label text-left">Due Days</label>
                                <div class="col-md-7">
                                    <input type="text" class="form-control" name="due_days" id="due_days" value="0">
                                </div>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="invoive_number" class="col-md-4 control-label text-left">Invoice Number</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="invoive_number" id="invoive_number" placeholder="Invoice Number" required>
                    ...
                    <hr/>
                            ...
                            <div class="form-group col-md-3">
                                <label for="discountsingle" class="col-md-4 control-label text-left">Discount%</label>
                                <div class="col-md-8">
