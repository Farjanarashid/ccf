<script>
    ...
    //data append into table from session
        ...
        $("#product_name").change(function(){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('salesfarmer/salesfarmer/unit_name'); ?>",
                data: dataString,
                success: function (data) {
                    var res = data.split(",");
                    $("#unitshow").val(res[1]);
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('salesfarmer/salesfarmer/product_salerate'); ?>",
                data: dataString,
                success: function (data) {
                    $("#rate").val(data);
                }
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('salesfarmer/salesfarmer/product_qty'); ?>",
                data: dataString,
                success: function (data) {
                    var range=data;
                    if(range==""){
    ...
    $("#order_no").change(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('salesfarmer/salesfarmer/checkorderno'); ?>",
            data: dataString,
            success: function (data) {
                if(data=="found"){
