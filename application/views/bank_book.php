        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="adv-table editable-table ">
                    <div class="clearfix">
                        <form class="tasi-form" method="post" action="<?php echo site_url('home/bank_book'); ?>">
                                       ...
                                       <div class="form-group">
                                           <ul class="nav nav-tabs" role="tablist" id="myTab">
                                               <li role="presentation" class="active">
                                                   <input type="radio"><a href="#ledger" aria-controls="home" role="tab" data-toggle="tab">Ledger Wise</a></li>
                                               <li role="presentation"><a href="#group" aria-controls="profile" role="tab" data-toggle="tab">  Group Wise</a></li>
                                           </ul>
                                       </div>
                                   </div>
                               </div>  -->
                            ...
                            <table  class="table table-striped table-hover table-bordered tab-pane active editable-sample1" id="editable-sample">
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td class="center"><?php echo $lageralldebit; ?></td>
                                        <td class="center"><?php echo $lagerallcredit; ?></td>
                                    </tr>
                                </tbody>
                            </table>
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                <ul class="unstyled amounts">
                                                    <li><strong> Total Balance : &nbsp; </strong><span class="align-right "> <?php
