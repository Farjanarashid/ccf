...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap core CSS -->
<!--        <link href="<?php echo $baseurl; ?>assets/media/css/demo_page.css" rel="stylesheet" />-->
    ...
    <body>
        ...
        <section id="container" >
            ...
            <header class="header white-bg">
                ...
                <!--logo start-->
                <a href="<?php echo site_url('home'); ?>" class="logo">CCF</a>
                <!--logo end-->
                    ...
                    <ul class="nav top-menu">
                        ...
                        <li id="header_inbox_bar" class="dropdown">
                            ...
                            <ul class="dropdown-menu extended inbox">
                                ...
                                <li>
                                    <a href="#">
                                        <span class="photo"><img alt="avatar" src="<?php echo $baseurl; ?>assets/img/avatar1_small.jpg"></span>
                                        <span class="subject">
                ...
                <div class="top-nav ">
                    ...
                    <ul class="nav pull-right top-menu">
                        ...
                        <li class="dropdown">
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <img style="border-radius: 4px" alt="" src="<?php echo $baseurl; ?>assets/img/avatar1_small.jpg">
                                <span class="username"><?php $username = $this->session->userdata('logindata');
