                                                        ...
                                                        <div class="form">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div class="col-lg-8">
                                                                        <select class="form-control" id="editgroupUnder<?php echo $row->accountGroupId; ?>" name="editgroupUnder" type="text">
                                                                            <?php
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel-body">
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-8">
                                        <select class="form-control" id="groupUnder" name="groupUnder" type="text" required >
