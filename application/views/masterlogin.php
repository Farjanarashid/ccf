        ...
        <div class="container">            
            <form class="form-signin" action="<?php echo site_url('login'); ?>" method="post">
                ...
                <div class="login-wrap"> 
                    ...
                    <select class="form-control m-bot15" required style="padding: 6px" name="compantid" onchange="getfyear(this.value)">
                        <option value="">-- Select Your Company --</option>
                        <?php
                        if (sizeof($companylist) > 0):
                            foreach ($companylist as $cpanydata):
                                ?>
                                <option value="<?php echo $cpanydata->companyId; ?>"><?php echo $cpanydata->companyName; ?></option>
                                <?php
                            endforeach;
                        endif;
                        ?>
